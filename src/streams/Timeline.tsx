import { DispatcherSession } from "@uniscale-sdk/ActorCharacter-RunwellX"
import { MessageFull } from "@uniscale-sdk/ActorCharacter-RunwellX/sdk/RunwellDemo/Streams/Streams/Timeline"
import { GetMessageList } from "@uniscale-sdk/ActorCharacter-RunwellX/sdk/RunwellDemo/Streams_1_0/Functionality/ServiceToModule/Streams/Timeline/LiveTimelineView/ListMessages"
import { SendMessage } from "@uniscale-sdk/ActorCharacter-RunwellX/sdk/RunwellDemo/Streams_1_0/Functionality/ServiceToModule/Streams/Timeline/LiveTimelineView/SendMessage"
import { UserFull } from "@uniscale-sdk/ActorCharacter-RunwellX/sdk/RunwellDemo/Account/Account"
import { LookupUsers } from "@uniscale-sdk/ActorCharacter-RunwellX/sdk/RunwellDemo/Account_1_0/Functionality/ServiceToModule/Account/UserQueries/UserLookup"
...
export const Timeline = (props: TimelineProps) => {
    ...
    const getMessages = async () => {
        ...
        var result = await props.dispatcher.request(GetMessageList.with(0))
        if (!result.success) {
